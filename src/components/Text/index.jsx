...
//difining the classes which will be used later by the sizeClasses object
const sizeClasses = {
...
const Text = ({ children, className = "", size, as, ...restProps }) => {
  ...
  return (
    <Component  className={`text-left ${className} ${size && sizeClasses[size]}`} {...restProps}> {children} </Component>
  );
};
